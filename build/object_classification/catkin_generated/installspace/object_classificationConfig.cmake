...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'object_classification' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/paschalidoud/pandora_RoCKIn2014/install/${idir}'.  Ask the maintainer 'aitor <aitor@todo.todo>' to fix it.")
    endif()
