...
#include <shape_simple_classifier/pcl_conversions.h>
...
#include "shape_simple_classifier/segmenter.h"
...
class ShapeClassifier
{
  private:
    ...
    ros::NodeHandle n_;
#ifdef SOC_VISUALIZE
    static boost::shared_ptr<pcl::visualization::PCLVisualizer> vis_;
#endif
  ...
  public:
    ...
    void run()
    {
      // NOTE: This is stupid busy waiting!
      // TODO: Need a better way to spin ros and visualizer at the same time.
...
boost::shared_ptr<pcl::visualization::PCLVisualizer> ShapeClassifier::vis_;
