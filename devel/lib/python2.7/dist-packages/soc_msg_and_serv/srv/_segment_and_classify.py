"""autogenerated by genpy from soc_msg_and_serv/segment_and_classifyRequest.msg. Do not edit."""
import sys
...
class segment_and_classifyRequest(genpy.Message):
  ...
  _type = "soc_msg_and_serv/segment_and_classifyRequest"
...
"""autogenerated by genpy from soc_msg_and_serv/segment_and_classifyResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class segment_and_classifyResponse(genpy.Message):
  _md5sum = "2e30bd2dbf857aa0f6760754816ef92e"
  _type = "soc_msg_and_serv/segment_and_classifyResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """std_msgs/String[] categories_found
...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.categories_found)
      buff.write(_struct_I.pack(length))
      for val1 in self.categories_found:
        _x = val1.data
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.categories_found.append(val1)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
class segment_and_classify(object):
  _type          = 'soc_msg_and_serv/segment_and_classify'
  _md5sum = 'ba1a61e6bd27f094c2048ad9a6c22150'
